...
class HomeTvPageState extends State<HomeTvPage> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() => {
          context.read<TvBloc>().add(const FetchTvData()),
          context.read<PopularTvBloc>().add(const FetchTvData()),
          context.read<TopRatedTvBloc>().add(const FetchTvData()),
        });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      drawer: const NavigationMenu(currentRoute: 'tv'),
      appBar: AppBar(
